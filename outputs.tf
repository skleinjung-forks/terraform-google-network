...
output "network_name" {
  value       = var.create_network ? google_compute_network.network[0].name : data.google_compute_network.network[0].name
  description = "The name of the VPC being created"
}

output "network_self_link" {
  value       = var.create_network ? google_compute_network.network[0].self_link : data.google_compute_network.network[0].self_link
